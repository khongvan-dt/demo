...
require '../db/db.php';
$Id = $_GET['id'];
$sql = "SELECT * FROM name_shop WHERE id='$Id'";
...
if (isset($_POST['save'])) {
    ...
    $sqlUpdate = "UPDATE name_shop SET 
        title='$title',
        img_t='$img'
        WHERE id='$Id'";
                            ...
                            <div class="card-body">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <th>tên shop</th>
                                        <th>
                                            <input type="text" name="name" value="<?php echo $list_cater['title']; ?>">
                                        </th>
                                    </tr>
                                    <tr>
                                        <th>Ảnh SP</th>
                                        <th>
                                            ...
                                            <?php if ($list_cater['img_t']) { ?>
                                                <img src="./upload/<?php echo $list_cater['img_t']; ?>" width="150px" height="100px">
                                            <?php } ?>
                                        </th>
                                    </tr>
                                    <tr>
